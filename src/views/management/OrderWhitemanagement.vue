                    ...
                    <div style="margin-top: 20px">
                        <Row :gutter="50">
                            <Col span="12">
                                <Card>
                                    <p slot="title">订单信息</p>
                                     <p>订单总金额(积分)：<span style="font-size: 16px;color: red">{{orderDetails.total}}</span></p>

                                    <p>支付方式：<span style="font-size: 16px">{{orderDetails.payment_method==""?"待支付":"白积分"}}</span></p>
...
//                          }
        ...
        methods: {
            ...
            show (index){
              ...
              $.ajax({
                url:Config.apiRootPath+Config.api.management.OrderWhitemanagement.view,
                type: 'POST',
                dataType: 'json',
                data: postData
              })
