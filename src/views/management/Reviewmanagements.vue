...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            //controller
            checkPower (dotype) {
                return !!this.$store.state.Rights[Config.api.management.Reviewmanagements[dotype].MD5()];
            },
            ...
            getList () {
                ...
                $.ajax({
                    url: Config.apiRootPath+Config.api.management.Reviewmanagements.list,
                    type: 'POST',
                    dataType: 'json',
                    data: postData
                })
            ...
            batchOperation(){
                ...
                $.ajax({
                    url: Config.apiRootPath+Config.api.management.Reviewmanagements.review,
                    type: 'POST',
                    dataType: 'json',
                    data: data
                })
