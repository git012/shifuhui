...
<template>
    <div>
            ...
            <div class="doBox">
                ...
                <div class="ordler-list" v-if="doType=='list'">
                  ...
                  <!--   <Button type="primary" :loading="loadBut" style="margin: 10px 0 10px" @click="batchOperation()" >批量操作</Button> -->
                    <Table border width="100%" :columns="columns" :loading="getLoading" :data="tableData" ></Table>
        ...
        <Modal title="审核" v-model="visible">
                        ...
                        return h('div', {
                          attrs: {
                            ...
                            h('img', {
                              ...
                              attrs: {
                                src: params.row.license_image, 
                                style: 'width: 100px;height:60px;border-radius: 2px;'
                              },
                             style: {
                                marginTop:'15px',
                                // marginBottom:'25px'
                              ...
                              on:{
                                click: () => {
                                        // this.doWhat("review",params.index,-1)
                                         this.handleView(params.row.license_image);
                                    }
                            ...
                            h('img', {
                              ...
                              style: {
                               ...
                               on:{
                                click: () => {
                                        // this.doWhat("review",params.index,-1)
                                         this.handleView(params.row.front_image);
                                    }
                            ...
                            h('img', {
                              ...
                              style: {
                               ...
                               on:{
                                click: () => {
                                        // this.doWhat("review",params.index,-1)
                                         this.handleView(params.row.reverse_image);
                                    }
