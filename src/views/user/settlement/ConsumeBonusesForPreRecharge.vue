            ...
            <Row>
                ...
                <Col span="13">
                    <div class="buttonGroup">
                        <Button type="error">消费增值积分</Button>
                        <Button type="primary" @click="$emit('doWhat','userBuyIntegralForPreRechargeList')">购物积分</Button>
                        <Button type="primary" @click="$emit('doWhat','userReturnIntegralForPreRechargeList')">全返积分</Button>
                    </div>
                </Col>
            </Row>
...
export default {
    name: 'ConsumeBonusesForPreRecharge',
    ...
    data () {
        return {
            columns: [
                ...
                },
                {
                    ...
                    render: (h, params) => {
                        ...
                        let tagText="";
                        return h('span', {}, params.row.ratio + "%");
                    }
                },
                {
                    title: '类型',
            ...
            recordKind:["正常","转出现金账户服务费","购买购物积分","转入预购充值账户"],
